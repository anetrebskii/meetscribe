...
— 23+ languages: English, Spanish, French, German, Japanese, Korean, Chinese, Russian, Arabic, Portuguese, and more — switch languages mid-call
— Floating in-page panel: draggable, resizable, and minimizable — stays out of your way
...
— Smart merging: consecutive messages from the same speaker are combined into coherent paragraphs
— Meeting resume: rejoin within 10 minutes and the transcript picks up where it left off

EXPORT

— Download as Markdown (.md) — formatted with speaker names and timestamps, ready to share or archive
— Copy to clipboard — one click to copy the full transcript as Markdown, ready to paste into docs or notes
